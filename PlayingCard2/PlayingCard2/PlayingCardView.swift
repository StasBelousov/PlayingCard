...
class PlayingCardView: UIView {
    ...
    private func drawPips () {
        ...
        func createPipsString(thatFits pipRect:CGRect) -> NSAttributedString {
            ...
            let probablyOkeyPipsStringFontSize = verticalPipRowSpacing / (attemptedPipString.size().height / verticalPipRowSpacing)
            let probablyOkeyPipString = centeredAttributedString(suit, fontSize: probablyOkeyPipsStringFontSize)
            if probablyOkeyPipString.size().width > pipRect.size.width / maxHorizontalPipCount {
                return centeredAttributedString(suit, fontSize: probablyOkeyPipsStringFontSize / (probablyOkeyPipString.size().width / (pipRect.size.width / maxHorizontalPipCount)))}
                else {
